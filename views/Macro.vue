    ...
    <div class="filter-section">
      ...
      <div class="filter-tabs">
        ...
        >
          ...
          <span>Protein</span>
          <div class="count">{{ proteinArticles.length }}</div>
        </div>
        ...
        >
          ...
          <span>Fats</span>
          <div class="count">{{ fatArticles.length }}</div>
        </div>
        ...
        >
          ...
          <div class="count">{{ carbArticles.length }}</div>
        </div>
      </div>
    </div>
...
import { macroArticles } from '../data/macroArticles.js'
...
// Use shared articles data for macronutrients
const allArticles = ref(macroArticles)

// Computed properties for filtering
const proteinArticles = computed(() => 
  allArticles.value.filter(article => article.subcategory === 'protein')
)

const fatArticles = computed(() => 
  allArticles.value.filter(article => article.subcategory === 'fats')
)

const carbArticles = computed(() => 
  allArticles.value.filter(article => article.subcategory === 'carbs')
)
