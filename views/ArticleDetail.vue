...
// Use shared articles data (in real app, this would come from API)
const allArticles = macroArticles
...
const fetchArticle = async () => {
  ...
  if (foundArticle) {
    ...
    relatedArticles.value = allArticles
      .filter(a => a.subcategory === foundArticle.subcategory && a.id !== foundArticle.id)
      .slice(0, 3)
  }
