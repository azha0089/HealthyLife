      ...
      <div class="desktop-menu">
        ...
        >
          ...
          <el-sub-menu index="recipes">
            ...
            <el-menu-item index="/recipes/breakfast" route="/recipes/breakfast">
              <el-icon><Sunrise /></el-icon>
              <span>Breakfast</span>
            </el-menu-item>
            <el-menu-item index="/recipes/lunch" route="/recipes/lunch">
              <el-icon><Sunny /></el-icon>
              <span>Lunch</span>
            </el-menu-item>
            <el-menu-item index="/recipes/vegan" route="/recipes/vegan">
              <el-icon><Orange /></el-icon>
              <span>Vegan</span>
            </el-menu-item>
            <el-menu-item index="/recipes/detail" route="/recipes/detail">
